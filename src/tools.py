...
class UIUCDatabaseTool(BaseTool):
    name = "UIUCDatabase"
    description = "used to get expert data about UIUC faculty and news. You should consider this as the MOST IMPORTANT but not only source of information about anything related to UIUC. Search and scrape if this info is not adequate."
